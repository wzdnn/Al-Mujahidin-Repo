        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['dekan'] == "" || $_REQUEST['niy'] == ""
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $status)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $dekan)){
                                            $_SESSION['dekan'] = 'Form Nama Kepala Sekolah hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {

                                            if(!preg_match("/^[0-9 -]*$/", $niy)){
                                                $_SESSION['niydekan'] = 'Form niy Kepala Sekolah hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',dekan='$dekan',niy='$niy',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',dekan='$dekan',niy='$niy',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="dekan" type="text" class="validate" name="dekan" value="<?php echo $row['dekan']; ?>" required>
                                            ...
                                            ?>
                                        <label for="dekan">Nama Kepala Sekolah</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="niy" type="text" class="validate" name="niy" value="<?php echo $row['niy']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['niydekan'])){
                                                    $niydekan = $_SESSION['niydekan'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$niydekan.'</div>';
                                                    unset($_SESSION['niydekan']);
                                                }
                                            ?>
                                        <label for="niy">NIP Kepala Sekolah</label>
                                    </div>
                                    <div class="input-field col s6">
