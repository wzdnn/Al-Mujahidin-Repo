                ...
                if (isset($_REQUEST['page'])) {
                    ...
                    switch ($page) {
                        ...
                        case 'gsk':
                            ...
                            break;
                        case 'tsr':
                            include "transaksi_surat_rahasia.php";
                            break;
                        case 'gsr':
                            include "galeri_sr.php";
                            break;
                        case 'asr':
                            include "agenda_surat_rahasia.php";
                            break;
                    }
                } else {
                ?>
                                ...
                                <div class="card-content">
                                    ...
                                    <p class="description">Anda login sebagai
                                        ...
                                        if ($_SESSION['admin'] == 1) {
                                            ...
                                            echo "<strong>Kepala Sekolah</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
