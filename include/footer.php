...
?>
            ...
            <div class="container" id="footer">
                <div class="row">
                    <div class="col-4 offset-3">
                        <p style="text-align:center"> SMA AL-Mujahidin Website @Copyright by Athena From Universitas Ahmad Dahlan </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Javascript START -->
    <script src="https://use.fontawesome.com/f06e36e45c.js"></script>
