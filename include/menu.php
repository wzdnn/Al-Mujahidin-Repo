...
?>
    ...
    <nav class="blue-grey darken-1">
        <div class="nav-wrapper">
            <a href="./" class="brand-logo center"><i class="material-icons md-36"></i> Pengelolaan Arsipan Surat</a>
                ...
                <li class="no-padding">
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            if (!empty($data['uad'])) {
                                echo '<img class="logoside" src="./upload/' . $data['uad'] . '"/>';
                            } else {
                                echo '<img class="logoside" src="./asset/img/uad.jpeg"/>';
                            }
                            if (!empty($data['Sekolah'])) {
                                echo '<img class="logoside" src="./upload/' . $data['Sekolah'] . '"/>';
                            } else {
                                echo '<img class="logoside" src="./asset/img/Sekolah.png"/>';
                            }
                            if (!empty($data['Athena Logo'])) {
                                echo '<img class="logoside" src="./upload/' . $data['Athena Logo'] . '"/>';
                            } else {
                                echo '<img class="logoside" src="./asset/img/Athena Logo.png"/>';
                            }
                            if (!empty($data['nama'])) {
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <?php
                                        if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 4) { ?>
                                            <li><a href="?page=tsr">Surat Rahasia</a></li>
                                        <?php
                                        }
                                        ?>
                                    </ul>
                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <?php
                                    if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 4) { ?>
                                        <li><a href="?page=asr">Surat Rahasia</a></li>
                                    <?php
                                    }
                                    ?>
                                </ul>
                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <?php
                                    if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 4) { ?>
                                        <li><a href="?page=gsr">Surat Rahasia</a></li>
                                    <?php
                                    }
                                    ?>
                                </ul>
