                            ...
                            if (!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)) {
                                ...
                                if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                    ...
                                    if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)) {
                                        ...
                                        $cek = mysqli_query($config, "SELECT * FROM tbl_surat_rahasia WHERE no_surat='$no_surat'");
                                            ...
                                            if ($file != "") {
                                                ...
                                                if (in_array($eks, $ekstensi) == true) {
                                                    if ($ukuran < 2500000) {
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_rahasia(no_agenda,tujuan,no_surat,isi,kode,tgl_surat,
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue-grey darken-1">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="?page=tsr&act=add" class="judul"><i class="material-icons">drafts</i> Tambah Data Surat Rahasia</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
            ...
            <form class="col s12" method="POST" action="?page=tsr&act=add" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        $sql = mysqli_query($config, "SELECT no_agenda FROM tbl_surat_rahasia");
                        $no_agenda = "1";
