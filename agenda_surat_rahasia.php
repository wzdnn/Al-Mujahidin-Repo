...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == "") {
            ...
            $query = mysqli_query($config, "SELECT * FROM tbl_surat_rahasia WHERE tgl_catat BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=asr" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Rahasia<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
            ...
            echo '<span id="alamat">' . $alamat . '</span>
                            ...
                            <h5 class="hid">AGENDA SURAT RAHASIA</h5>
                        <div class="col s10">
                            <p class="warna agenda">Agenda Surat Rahasia dari tanggal <strong>' . indoDate($dari_tanggal) . '</strong> sampai dengan tanggal <strong>' . indoDate($sampai_tanggal) . '</strong></p>
                        </div>
                        <div class="col s2">
