                ...
                if (!preg_match("/^[a-zA-Z0-9. ]*$/", $kode)) {
                    ...
                    if (!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $nama)) {
                        ...
                        if (!preg_match("/^[a-zA-Z0-9.,()\/\r\n -]*$/", $tujuan)) {
                            $_SESSION['tujuan'] = 'Form tujuan hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                            ...
                            if (!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $penerima)) {
                                ...
                                if ($result > 0) {
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO tbl_klasifikasi(kode,nama,tujuan,penerima,id_user) VALUES('$kode','$nama','$tujuan','$penerima','$id_user')");
                ...
                <form class="col s12" method="post" action="?page=ref&act=add">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            ...
                            <textarea id="penerima" class="materialize-textarea" name="penerima" required></textarea>
                            <?php
                        ...
                        <div class="input-field col s12">
                            ...
                            <textarea id="tujuan" class="materialize-textarea" name="tujuan" required></textarea>
                            <?php
